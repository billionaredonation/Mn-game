function getSkillConfig(skillCode, xp = 0) {
  if (skillCode === "farmer") {
    const levels = [
      ...
      { level: 2, minXp: 100, reward: 25, actionXp: 4, nextXp: 500 },
      { level: 3, minXp: 500, reward: 50, actionXp: 6, nextXp: 1000 },
      { level: 4, minXp: 1000, reward: 75, actionXp: 10, nextXp: 2000 },
      { level: 5, minXp: 2000, reward: 90, actionXp: 15, nextXp: 2500 },
      { level: 6, minXp: 2500, reward: 100, actionXp: 20, nextXp: 5000 },
      { level: 7, minXp: 5000, reward: 150, actionXp: 50, nextXp: 6500 },
      { level: 8, minXp: 6500, reward: 200, actionXp: 75, nextXp: 7500 },
      { level: 9, minXp: 7500, reward: 250, actionXp: 90, nextXp: 10000 },
      { level: 10, minXp: 10000, reward: 300, actionXp: 100, nextXp: 10000 }
    ];
